/* prettier-ignore */ import { UserSessionCreateType, UserSessionDetailType, } from '@to-do/api-schemas/user-session-schema';
/* prettier-ignore */ import { Create, failed, Find, Result, success, } from '@to-do/service-framework/service';
import { client } from '@to-do/repositories/prisma-repo';
import cryptoUtils from '@to-do/utilities/crypto-utils';
import { Prisma } from '@prisma/client';

export const createUserSession: Create<
